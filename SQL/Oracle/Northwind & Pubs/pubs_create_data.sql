...
/
INSERT INTO sales values('7066', 'QA7442.3', TO_DATE('09/13/94', 'MM/DD/YY'), 75, 'ON invoice','PS2091')
;INSERT INTO sales values('7067', 'D4482', TO_DATE('09/14/94', 'MM/DD/YY'), 10, 'Net 60','PS2091')
;INSERT INTO sales values('7131', 'N914008', TO_DATE('09/14/94', 'MM/DD/YY'), 20, 'Net 30','PS2091')
;INSERT INTO sales values('7131', 'N914014', TO_DATE('09/14/94', 'MM/DD/YY'), 25, 'Net 30','MC3021')
;INSERT INTO sales values('8042', '423LL922', TO_DATE('09/14/94', 'MM/DD/YY'), 15, 'ON invoice','MC3021')
;INSERT INTO sales values('8042', '423LL930', TO_DATE('09/14/94', 'MM/DD/YY'), 10, 'ON invoice','BU1032')
;INSERT INTO sales values('6380', '722a', TO_DATE('09/13/94', 'MM/DD/YY'), 3, 'Net 60','PS2091')
;INSERT INTO sales values('6380', '6871', TO_DATE('09/14/94', 'MM/DD/YY'), 5, 'Net 60','BU1032')
;INSERT INTO sales values('8042','P723', TO_DATE('03/11/93', 'MM/DD/YY'), 25, 'Net 30', 'BU1111')
;INSERT INTO sales values('7896','X999', TO_DATE('02/21/93', 'MM/DD/YY'), 35, 'ON invoice', 'BU2075')
;INSERT INTO sales values('7896','QQ2299', TO_DATE('10/28/93', 'MM/DD/YY'), 15, 'Net 60', 'BU7832')
;INSERT INTO sales values('7896','TQ456', TO_DATE('12/12/93', 'MM/DD/YY'), 10, 'Net 60', 'MC2222')
;INSERT INTO sales values('8042','QA879.1', TO_DATE('5/22/93', 'MM/DD/YY'), 30, 'Net 30', 'PC1035')
;INSERT INTO sales values('7066','A2976', TO_DATE('5/24/93', 'MM/DD/YY'), 50, 'Net 30', 'PC8888')
;INSERT INTO sales values('7131','P3087a', TO_DATE('5/29/93', 'MM/DD/YY'), 20, 'Net 60', 'PS1372')
;INSERT INTO sales values('7131','P3087a', TO_DATE('5/29/93', 'MM/DD/YY'), 25, 'Net 60', 'PS2106')
;INSERT INTO sales values('7131','P3087a', TO_DATE('5/29/93', 'MM/DD/YY'), 15, 'Net 60', 'PS3333')
;INSERT INTO sales values('7131','P3087a', TO_DATE('5/29/93', 'MM/DD/YY'), 25, 'Net 60', 'PS7777')
;INSERT INTO sales values('7067','P2121', TO_DATE('6/15/92', 'MM/DD/YY'), 40, 'Net 30', 'TC3218')
;INSERT INTO sales values('7067','P2121', TO_DATE('6/15/92', 'MM/DD/YY'), 20, 'Net 30', 'TC4203')
;INSERT INTO sales values('7067','P2121', TO_DATE('6/15/92', 'MM/DD/YY'), 20, 'Net 30', 'TC7777');
...
/
INSERT INTO employee values ('PTC11962M', 'Philip', 'T', 'Cramer', 2, 215, '9952', TO_DATE('11/11/89', 'MM/DD/YY'))
;INSERT INTO employee values ('AMD15433F', 'Ann', 'M', 'Devon', 3, 200, '9952', TO_DATE('07/16/91', 'MM/DD/YY'))
;INSERT INTO employee values ('F-C16315M', 'Francisco', '', 'Chang', 4, 227, '9952', TO_DATE('11/03/90', 'MM/DD/YY'))
;INSERT INTO employee values ('LAL21447M', 'Laurence', 'A', 'Lebihan', 5, 175, '0736', TO_DATE('06/03/90', 'MM/DD/YY'))
;INSERT INTO employee values ('PXH22250M', 'Paul', 'X', 'Henriot', 5, 159, '0877', TO_DATE('08/19/93', 'MM/DD/YY'))
;INSERT INTO employee values ('SKO22412M', 'Sven', 'K', 'Ottlieb', 5, 150, '1389', TO_DATE('04/05/91', 'MM/DD/YY'))
;INSERT INTO employee values ('RBM23061F', 'Rita', 'B', 'Muller', 5, 198, '1622', TO_DATE('10/09/93', 'MM/DD/YY'))
;INSERT INTO employee values ('MJP25939M', 'Maria', 'J', 'Pontes', 5, 246, '1756', TO_DATE('03/01/89', 'MM/DD/YY'))
;INSERT INTO employee values ('JYL26161F', 'Janine', 'Y', 'Labrune', 5, 172, '9901', TO_DATE('05/26/91', 'MM/DD/YY'))
;INSERT INTO employee values ('CFH28514M', 'Carlos', 'F', 'Hernadez', 5, 211, '9999', TO_DATE('04/21/89', 'MM/DD/YY'))
;INSERT INTO employee values ('VPA30890F', 'Victoria', 'P', 'Ashworth', 6, 140, '0877', TO_DATE('09/13/90', 'MM/DD/YY'))
;INSERT INTO employee values ('L-B31947F', 'Lesley', '', 'Brown', 7, 120, '0877', TO_DATE('02/13/91', 'MM/DD/YY'))
;INSERT INTO employee values ('ARD36773F', 'Anabela', 'R', 'Domingues', 8, 100, '0877', TO_DATE('01/27/93', 'MM/DD/YY'))
;INSERT INTO employee values ('M-R38834F', 'Martine', '', 'Rance', 9, 75, '0877', TO_DATE('02/05/92', 'MM/DD/YY'))
;INSERT INTO employee values ('PHF38899M', 'Peter', 'H', 'Franken', 10, 75, '0877', TO_DATE('05/17/92', 'MM/DD/YY'))
;INSERT INTO employee values ('DBT39435M', 'Daniel', 'B', 'Tonini', 11, 75, '0877', TO_DATE('01/01/90', 'MM/DD/YY'))
;INSERT INTO employee values ('H-B39728F', 'Helen', '', 'Bennett', 12, 35, '0877', TO_DATE('09/21/89', 'MM/DD/YY'))
;INSERT INTO employee values ('PMA42628M', 'Paolo', 'M', 'Accorti', 13, 35, '0877', TO_DATE('08/27/92', 'MM/DD/YY'))
;INSERT INTO employee values ('ENL44273F', 'Elizabeth', 'N', 'Lincoln', 14, 35, '0877', TO_DATE('07/24/90', 'MM/DD/YY'));

/
INSERT INTO employee values ('MGK44605M', 'Matti', 'G', 'Karttunen', 6, 220, '0736', TO_DATE('05/01/94', 'MM/DD/YY'))
;INSERT INTO employee values ('PDI47470M', 'Palle', 'D', 'Ibsen', 7, 195, '0736', TO_DATE('05/09/93', 'MM/DD/YY'))
;INSERT INTO employee values ('MMS49649F', 'Mary', 'M', 'Saveley', 8, 175, '0736', TO_DATE('06/29/93', 'MM/DD/YY'))
;INSERT INTO employee values ('GHT50241M', 'Gary', 'H', 'Thomas', 9, 170, '0736', TO_DATE('08/09/88', 'MM/DD/YY'))
;INSERT INTO employee values ('MFS52347M', 'Martin', 'F', 'Sommer', 10, 165, '0736', TO_DATE('04/13/90', 'MM/DD/YY'))
;INSERT INTO employee values ('R-M53550M', 'Roland', '', 'Mendel', 11, 150, '0736', TO_DATE('09/05/91', 'MM/DD/YY'))
;INSERT INTO employee values ('HAS54740M', 'Howard', 'A', 'Snyder', 12, 100, '0736', TO_DATE('11/19/88', 'MM/DD/YY'))
;INSERT INTO employee values ('TPO55093M', 'Timothy', 'P', 'O''Rourke', 13, 100, '0736', TO_DATE('06/19/88', 'MM/DD/YY'))
;INSERT INTO employee values ('KFJ64308F', 'Karin', 'F', 'Josephs', 14, 100, '0736', TO_DATE('10/17/92', 'MM/DD/YY'))
;INSERT INTO employee values ('DWR65030M', 'Diego', 'W', 'Roel', 6, 192, '1389', TO_DATE('12/16/91', 'MM/DD/YY'))
;INSERT INTO employee values ('M-L67958F', 'Maria', '', 'Larsson', 7, 135, '1389', TO_DATE('03/27/92', 'MM/DD/YY'))
;INSERT INTO employee values ('PSP68661F', 'Paula', 'S', 'Parente', 8, 125, '1389', TO_DATE('01/19/94', 'MM/DD/YY'))
;INSERT INTO employee values ('MAS70474F', 'Margaret', 'A', 'Smith', 9, 78, '1389', TO_DATE('09/29/88', 'MM/DD/YY'))
;INSERT INTO employee values ('A-C71970F', 'Aria', '', 'Cruz', 10, 87, '1389', TO_DATE('10/26/91', 'MM/DD/YY'))
;INSERT INTO employee values ('MAP77183M', 'Miguel', 'A', 'Paolino', 11, 112, '1389', TO_DATE('12/07/92', 'MM/DD/YY'))
;INSERT INTO employee values ('Y-L77953M', 'Yoshi', '', 'Latimer', 12, 32, '1389', TO_DATE('06/11/89', 'MM/DD/YY'))
;INSERT INTO employee values ('CGS88322F', 'Carine', 'G', 'Schmitt', 13, 64, '1389', TO_DATE('07/07/92', 'MM/DD/YY'))
;INSERT INTO employee values ('PSA89086M', 'Pedro', 'S', 'Afonso', 14, 89, '1389', TO_DATE('12/24/90', 'MM/DD/YY'))
;INSERT INTO employee values ('A-R89858F', 'Annette', '', 'Roulet', 6, 152, '9999', TO_DATE('02/21/90', 'MM/DD/YY'))
;INSERT INTO employee values ('HAN90777M', 'Helvetius', 'A', 'Nagy', 7, 120, '9999', TO_DATE('03/19/93', 'MM/DD/YY'))
;INSERT INTO employee values ('M-P91209M', 'Manuel', '', 'Pereira', 8, 101, '9999', TO_DATE('01/09/89', 'MM/DD/YY'))
;INSERT INTO employee values ('KJJ92907F', 'Karla', 'J', 'Jablonski', 9, 170, '9999', TO_DATE('03/11/94', 'MM/DD/YY'))
;INSERT INTO employee values ('POK93028M', 'Pirkko', 'O', 'Koskitalo', 10, 80, '9999', TO_DATE('11/29/93', 'MM/DD/YY'))
;INSERT INTO employee values ('PCM98509F', 'Patricia', 'C', 'McKenna', 11, 150, '9999', TO_DATE('08/01/89', 'MM/DD/YY'));
